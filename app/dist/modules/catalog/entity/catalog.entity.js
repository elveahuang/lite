...
let CatalogEntity = class CatalogEntity extends base_entity_1.BaseEntity {
    code;
    title;
    label;
    description;
...
], CatalogEntity.prototype, "code", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'title', comment: '标题' }),
    __metadata("design:type", String)
], CatalogEntity.prototype, "title", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'label', comment: '文本' }),
    __metadata("design:type", String)
], CatalogEntity.prototype, "label", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'description', comment: '备注' }),
    __metadata("design:type", String)
], CatalogEntity.prototype, "description", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'type', comment: '类型' }),
    __metadata("design:type", String)
], CatalogEntity.prototype, "type", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'idx', comment: '序号' }),
    __metadata("design:type", Number)
], CatalogEntity.prototype, "idx", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Number)
], CatalogEntity.prototype, "source", void 0);
