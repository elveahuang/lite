...
const authority_admin_controller_1 = require("./controller/authority.admin.controller");
const authority_app_controller_1 = require("./controller/authority.app.controller");
const dashboard_admin_controller_1 = require("./controller/dashboard.admin.controller");
const role_admin_controller_1 = require("./controller/role.admin.controller");
const role_app_controller_1 = require("./controller/role.app.controller");
const user_session_admin_controller_1 = require("./controller/user-session.admin.controller");
const user_admin_controller_1 = require("./controller/user.admin.controller");
const user_app_controller_1 = require("./controller/user.app.controller");
