...
(
    ...
    `password_expire_at`   DATETIME         NULL     DEFAULT NULL COMMENT '密码过期时间',
    `password_error_at`    DATETIME         NULL     DEFAULT NULL COMMENT '最后一次输入错误密码的时间',
...
(
    ...
    `description`      VARCHAR(255)     NOT NULL DEFAULT '' COMMENT '备注',
    `idx`              INT UNSIGNED     NOT NULL DEFAULT 999 COMMENT '序号',
    `start_datetime`   DATETIME         NOT NULL DEFAULT NOW() COMMENT '发布开始日期',
    `end_datetime`     DATETIME         NOT NULL DEFAULT NOW() COMMENT '发布结束日期',
    `status`           TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '发布状态',
    `active`           TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '启用状态',
    `created_by`       BIGINT UNSIGNED  NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_at`       DATETIME         NOT NULL DEFAULT NOW() COMMENT '创建时间',
...
(
    ...
    `description`      VARCHAR(255)     NOT NULL DEFAULT '' COMMENT '备注',
    `start_datetime`   DATETIME         NOT NULL DEFAULT NOW() COMMENT '发布开启日期',
    `end_datetime`     DATETIME         NOT NULL DEFAULT NOW() COMMENT '发布结束日期',
    `status`           TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '发布状态',
    `active`           TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '启用状态',
    `created_by`       BIGINT UNSIGNED  NOT NULL DEFAULT 0 COMMENT '创建人',
